...
# Bing: you should commit the files Project.toml and Manifest.toml instead,
# and use them as a julia environment. Then delete the notes below.
# Below shows the julia package version we used for this project: 
# (@v1.11) pkg> status
# Status `/afs/cs.wisc.edu/u/b/i/bingl/.julia/environments/v1.11/Project.toml`
#   [c7e460c6] ArgParse v1.2.0
#   [336ed68f] CSV v0.10.15
#   [a93c6f00] DataFrames v1.7.0
#   [aea672f4] Phylo v0.5.4
